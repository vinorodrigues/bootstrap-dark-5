...
>
> &#9888; In the meantime, any work aligning to BS curent core repo *(a.k.a. **5.2 Beta**)* will moved over to the [`dev/v1.2.0`](https://github.com/vinorodrigues/bootstrap-dark-5/tree/dev/v1.2.0) branch of this project.
