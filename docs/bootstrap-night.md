...
<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-dark-5@1.0.0/dist/css/bootstrap-night.min.css" rel="stylesheet">
...
<html lang="en">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-dark-5@1.0.0/dist/css/bootstrap-night.min.css" rel="stylesheet" media="(prefers-color-scheme: dark)">
    <!-- and then the primary CSS last ...
         in this case the (original) Bootstrap Variant CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-dark-5@1.0.0/dist/css/bootstrap.min.css" rel="stylesheet" media="(prefers-color-scheme: light)">
